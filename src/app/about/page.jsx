...
export default function AboutPage() {
  ...
  const C = {
    ...
    textPrimary:darkMode ? "#ffffff"               : "#0f1a30",
    textSecond: darkMode ? "#94a3b8"               : "#5e6675",
    gold:       "#f1af3c",
  ...
  return (
    <div className="page-wrapper" style={{ backgroundColor: darkMode ? "#0a0e1a" : "#ffffff", minHeight: "100vh", fontFamily: "'Inter', sans-serif", color: darkMode ? "#F9FAFB" : B.textNavy }}>
      ...
      <HeroSection darkMode={darkMode} C={C} go={go} />
      <DirectorsDesk darkMode={darkMode} C={C} />
      <PedagogySection darkMode={darkMode} C={C} />
      <InfrastructureSection darkMode={darkMode} C={C} />
      <Milestones darkMode={darkMode} C={C} />
      <Faculty darkMode={darkMode} C={C} />
      <OurStory darkMode={darkMode} C={C} />
      <CoreValues darkMode={darkMode} C={C} />
      <WhyChoose darkMode={darkMode} C={C} />
      <VisionCTA darkMode={darkMode} go={go} C={C} />
      ...
      <style>{`
        ...
        @media (min-width: 769px) {
          ...
          .achievements-list { grid-template-columns: repeat(2, 1fr) !important; }
        }
